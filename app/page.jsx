...
function Home() {
  ...
  const gridTemplateColumns = isChatVisible ? `${100 - chatWidthPercent}fr ${RESIZER_WIDTH}px ${chatWidthPercent}fr` : "1fr";
  ...
  >
    ...
    className={cn(
      "pointer-events-none",
      isChatVisible ? "absolute right-4 top-4 z-30" : "fixed right-6 top-24 z-40"
    )}
  >
                            <button
    type="button"
    ...
    className={cn(
      ...
      isChatVisible ? "border-gray-200 bg-white/90 text-gray-700 shadow-sm hover:bg-white" : "border-blue-500 bg-blue-600 text-white shadow-lg hover:bg-blue-500/90"
    )}
  >
                                {isChatVisible ? <>
                        ...
                        {showDrawio ? drawioError ? <div className="flex items-center justify-center h-full bg-white rounded border-2 border-red-200">
                                    ...
                                    {isDrawioLoading && <div className="absolute inset-0 flex items-center justify-center bg-white bg-opacity-75 z-10">
  ...
  >
    ...
    className={cn(
      ...
      isChatVisible ? "opacity-100" : "pointer-events-none opacity-0 translate-x-4"
    )}
  >
                            <ChatPanelOptimized
