...
[🚀 Live Preview](https://Figsci-5zwp.vercel.app/) | [📖 Documentation](./docs)

</div>

## 🎯 What is Figsci?

**Figsci** is an AI-driven flowchart tool powered by Large Language Models, designed for a "chat-while-drawing" experience. Simply describe your requirements in natural language, and watch professional draw.io diagrams come to life in real-time.
...
> Upload a reference image, and Figsci will replicate its style

| Original Reference               | AI Generated with Same Style       |
|----------------------------------|------------------------------------|
| ![Original](./public/image7.png) | ![Replicated](./public/image8.png) |

### Feature 3: Figsci Brief - Style Configuration
...
> Various flowcharts, sequence diagrams, and system architectures generated by Figsci
...
*This diagram was also generated using Figsci!*
...
Figsci natively supports multiple LLM providers:
...
Figsci concatenates configured prompts from the "Brief" section into the system prompt before each LLM call. Here are the available options:
...
If Figsci helps you, please give it a Star!

---

<div align="center">
Built with ❤️ by Figsci Team
</div>
