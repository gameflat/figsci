                    ...
                    <div className="flex flex-nowrap items-center gap-2 flex-1 min-w-0 justify-end">
                        ...
                        {isBusy ? (
                            ...
                            <Button
                                ...
                                className="h-[30px] min-w-[78px] gap-2 rounded-full bg-slate-900 text-white text-[11px] shadow-sm transition hover:bg-slate-900/90 disabled:opacity-60 flex-shrink-0"
                                size="sm"
                                aria-label="发送消息"
                            >
