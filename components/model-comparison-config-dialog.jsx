 ...
 * @property {string[]} models - 存储模型 key 的数组，最多 5 个
 */

/**
 * @typedef {Object} ModelComparisonConfigDialogProps
 * @property {boolean} open
 * @property {(next: boolean) => void} onOpenChange
 * @property {ComparisonModelConfig} config
 * @property {(next: ComparisonModelConfig) => void} onConfigChange
 * @property {string} [defaultPrimaryKey]
...
/**
 * @param {ModelComparisonConfigDialogProps} props
 */
export function ModelComparisonConfigDialog({
    ...
    const handleUpdateModel = (index, modelKey) => {
