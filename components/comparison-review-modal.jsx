...
/**
 * @param {{
 *   result: import("@/types/comparison").ComparisonCardResult;
 *   entry: import("@/types/comparison").ComparisonHistoryEntry;
 *   buildPreviewUrl: (xml: string) => string | null;
 *   onPreviewResult?: (requestId: string, result: import("@/types/comparison").ComparisonCardResult) => void;
 *   onApplyResult?: (result: import("@/types/comparison").ComparisonCardResult) => void;
 *   onCopyXml?: (xml: string) => void;
 *   onDownloadResult?: (result: import("@/types/comparison").ComparisonCardResult) => void;
 *   onRetryResult?: (
 *     entry: import("@/types/comparison").ComparisonHistoryEntry,
 *     result: import("@/types/comparison").ComparisonCardResult
 *   ) => void;
...
/**
 * @typedef {Object} ComparisonReviewModalProps
 * @property {import("@/types/comparison").ComparisonHistoryEntry | null} entry
 * @property {() => void} onClose
 * @property {(xml: string) => string | null} buildPreviewUrl
 * @property {(requestId: string, result: import("@/types/comparison").ComparisonCardResult) => void} [onPreviewResult]
 * @property {(result: import("@/types/comparison").ComparisonCardResult) => void} [onApplyResult]
 * @property {(xml: string) => void} [onCopyXml]
 * @property {(result: import("@/types/comparison").ComparisonCardResult) => void} [onDownloadResult]
 * @property {(entry: import("@/types/comparison").ComparisonHistoryEntry, result: import("@/types/comparison").ComparisonCardResult) => void} [onRetryResult]
 * @property {{ requestId: string; resultId: string } | null} [activePreview]
 */

/**
 * @param {ComparisonReviewModalProps} props
 */
