...
const Figsci_AI_CALIBRATION_PROMPT = `### Figsci 校准舱 · AI 重排指令
...
const FLOW_SHOWCASE_PRESETS = [
  ...
  },
  {
    ...
    prompt: "请绘制一张客户成功样板：左侧是发现、上线、扩散、续约四阶段旅程（含目标、触点、情绪）；右侧是 2×3 增购机会矩阵（行=现有团队/新团队，列=功能深用/增值模块/服务包），并用连接线指出高优先级机会。",
    tags: ["CSM", "旅程", "续约"],
