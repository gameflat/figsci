...
export function validateImage(file) {
  ...
  if (!Object.keys(SUPPORTED_IMAGE_TYPES).includes(file.type)) {
    return {
      isValid: false,
      error: `Unsupported image formats. Supported formats: ${Object.values(SUPPORTED_IMAGE_TYPES).join(', ')}`
    };
  }
...
基于分析结果，创建清晰、准确、符合学术论文标准的Excalidraw图表，确保：
- 保留图片中的所有关键信息
- 使用合适的图表类型展示内容
- 保持逻辑关系和结构
- 添加必要的文字说明
- 输出标准的Excalidraw Json格式`;
}
