...
/**
 * @typedef {import("@/types/model-config.d.ts").ModelEndpointConfig} ModelEndpointConfig
 */

/**
 * @typedef {Object} EnvModelConfig
...
/**
 * @typedef {Object} EnvEndpointConfig
 * @property {string} name
 * @property {string} baseUrl
 * @property {string} apiKey
 * @property {EnvModelConfig[]} models
 */
